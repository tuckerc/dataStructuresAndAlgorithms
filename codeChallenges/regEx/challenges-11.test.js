...
const validatePin = (pin) => {
  const regex = /\b[0-9][0-9][0-9][0-9]\b/g;
...
const validateEmail = (email) => {
  const regex = /^([A-Z0-9]\w+|[A-Z0-9]\w+.[A-Z0-9]\w+)\w+@[A-Z0-9]\w+(.com|.org|.net)$/gi;
...
const validatePhoneNumber = (phoneNumber) => {
  const regex = /^([0-9][0-9][0-9][0-9][0-9][0-9](-|)[0-9][0-9][0-9][0-9]|\([0-9][0-9][0-9]\)( |)[0-9][0-9][0-9]( |-)[0-9][0-9][0-9][0-9]|[0-9][0-9][0-9] [0-9][0-9][0-9]( |-|)[0-9][0-9][0-9][0-9]|[0-9][0-9][0-9]-[0-9][0-9][0-9]( ||-)[0-9][0-9][0-9][0-9])$/g;
